...
import SalesChannelProductPerformancePage from './pages/sales-performance/sales-channel-product-performance/SalesChannelPerformancePage';
import CategoryPerformancePage from './pages/sales-performance/category-performance/CategoryPerformancePage';
...
import PerformanceSearchPage from './pages/sales-performance/performance-search/PerformanceSearchPage';
                                ...
                                userRdx.userInfo.roles.includes("ROLE_LOGISTICS") ? (
                                    ...
                                    : (
                                        <Routes>
                                            ...
                                            {/* SalesPerformance Ex */}
                                            <Route path='/sales-performance' element={<SalesPerformancePageEx />} />
                                            ...
                                            <Route path='/sales-performance/search' element={<PerformanceSearchPage />} />
