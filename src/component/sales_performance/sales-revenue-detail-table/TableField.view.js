...
const TableBody = ({ tableData, onActionSearchNotSoldItem }) => {
    return (
        <tbody>
                        ...
                        <React.Fragment key={r1Index}>
                            <tr className='first-tr'>
                                ...
                                <td 
                                    ...
                                    onClick={() => onActionSearchNotSoldItem(r1.key)}
                                >
                                    {r1.unit - r1.salesUnit}개
                                </td>
                                ...
                                <td
                                    ...
                                    onClick={() => onActionSearchNotSoldItem(r1.key)}
                                >
                                    {(r1.revenue - r1.salesRevenue)?.toLocaleString()}원
                                </td>
                            </tr>
                        </React.Fragment>
                    )
        ...
        <TableFieldWrapper>
            <table cellSpacing="0" width='100%'>
                ...
                <TableBody
                    ...
                    onActionSearchNotSoldItem={props.onActionSearchNotSoldItem}
                ></TableBody>
            </table>
        </TableFieldWrapper>
    );
