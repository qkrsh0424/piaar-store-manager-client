...
const ReceiveStatusModal = (props) => {
    ...
    return (
        <>
            <Dialog
                ...
                maxWidth={maxWidth}
                open={props.open}
                onClose={() => props.__handleEventControl().receive().receiveModalClose()}
            >
                <Container>
                    <BodyWrapper style={{ borderBottom: '2px solid #f1f1f1' }}>
                        <GroupTitle>입고현황
                            <IconButton aria-label="close" className="closeButton" onClick={()=>props.__handleEventControl().receive().receiveModalClose()}>
                                <CloseIcon />
                            </IconButton>
                        </GroupTitle>
                        <NameGroup>
...
export default ReceiveStatusModal;