    ...
    return (
        <>
            <Dialog
                ...
                maxWidth={maxWidth}
                open={props.open}
                onClose={() => props.__handleEventControl().release().addModalClose()}
            >
                <Container>
                    <form onSubmit={(e) => props.__handleEventControl().release().submitAddData(e)}>
                        <BodyWrapper>
                            <GroupTitle>
                                출고등록
                            </GroupTitle>
                                    ...
                                    <table className="table" style={{ tableLayout: 'fixed' }}>
                                        <thead>
                                            <tr>
                                                ...
                                                <OptionTableTh scope="col" width='100'>출고수량 <i className="icon-must" aria-label="필수항목"></i></OptionTableTh>
                                            </tr>
                                        </thead>
                                        <tbody>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <OptionTableTd>
                                                                <OptionInput
                                                                    ...
                                                                    name='releaseUnit'
                                                                    onChange={(e) => props.__handleEventControl().release().addDataOnChangeInputValue(e, data.productRelease.id)}
                                                                    min={0}
                                                                ></OptionInput>
                                                            </OptionTableTd>
                                                        </tr>
                        ...
                        <BodyWrapper>
                            <div className="input-group mb-3">
                                ...
                                <CommonInputEl
                                    ...
                                    onChange={(e) => props.__handleEventControl().release().addDataOnChangeMemoValue(e)}
                                />
                            </div>
