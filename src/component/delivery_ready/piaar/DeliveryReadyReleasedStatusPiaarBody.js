...
const DeliveryReadyReleasedStatusPiaarBody = (props) => {
    ...
    const releasedExcelControl = () => {
        return {
            piaarReleasedStatusExcelData: function () {
                return {
                    checkAll: function () {
                    ...
                    getCombinedDeliveryItem: async function () {
                    ...
                    <div>
                        ...
                        <DataControlBox>
                            <ChangeBtn type="button" 
                                onClick={() => releasedExcelControl().piaarReleasedStatusExcelData().getCombinedDeliveryItem()}
                            >Test</ChangeBtn>
                        </DataControlBox>
                    </div>
...
export default withRouter(DeliveryReadyReleasedStatusPiaarBody);