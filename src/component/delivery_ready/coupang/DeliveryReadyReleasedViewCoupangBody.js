            ...
            {userRdx.isLoading === false &&
                <DataContainer>
                    <ReleaseDataControlBox>
                        <DateSelector onClick={() => props.__handleEventControl().deliveryReadyDateRangePicker().open()}><EventAvailableTwoToneIcon fontSize="small" color="action" /> {props.selectedDateText}</DateSelector>
                                ...
                                <thead>
                                    <tr>
                                        ...
                                        <HeaderTh className="fixed-header large-cell" scope="col">
                                            <span>등록상품명</span><ArrowDropDownIcon type="button" onClick={() => props.__handleEventControl().sortDataList().releasedDataSortedByProdName()}/>
                                        </HeaderTh>
                                        <HeaderTh className="fixed-header large-cell" scope="col">
                                            <span>등록옵션명</span>
                                        </HeaderTh>
