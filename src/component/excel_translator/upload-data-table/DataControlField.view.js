    ...
    return (
        <ControlFieldWrapper>
            ...
            <div className="control-box">
                <button type="button" className="upload-header-form-download" onClick={(e) => props.onActionDownloadExcelForm(e)} disabled={!(props.selectedHeaderTitleState?.uploadHeaderDetail.details.length)}>양식 다운로드</button>
