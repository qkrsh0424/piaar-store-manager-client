...
const CollectingComponent = (props) => {
    ...
    useEffect(() => {
        ...
        if(!defaultHeader || !defaultHeader.collectingHeaderId) {
            dispatchViewHeader({
                type: 'CLEAR'
            })
            return;
        ...
        let data = viewHeaderList.filter(r => r.id === defaultHeader.collectingHeaderId)[0];
        dispatchViewHeader({
            type: 'INIT_DATA',
            payload: data
        });
...
export default CollectingComponent;
