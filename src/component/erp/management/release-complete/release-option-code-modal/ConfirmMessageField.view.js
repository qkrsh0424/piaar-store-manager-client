import { ConfirmMessageFieldWrapper } from "./ReleaseOptionCodeModal.styled";
    ...
    return (
        <ConfirmMessageFieldWrapper>
            <div style={{ textAlign: 'center', marginTop: '10px', padding: '30px 0', fontSize: '14px', fontWeight: '600' }}>
                ...
                <div><span style={{ color: '#d15120' }}>[출고 옵션코드]</span> 가 변경됩니다.</div>
                <div>[{props.checkedOrderItemList?.length}]건 데이터를 정말로 변경 하시겠습니까?</div>
            </div>
