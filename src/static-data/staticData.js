...
function getDefaultHeaderDetails() {
    let result = staticDefaultHeaderDetails2.map((r, index) => {
        return {
            ...r,
            cellNumber: index
        }
...
function getDefaultHeaderFields() {
    let result = staticDefaultHeaderDetails2.map(r => {
